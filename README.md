...
## Weighted Multifractal py file
The _weighted_multifractal_graph.py_ contains:
- all the functions to perform the Expectation Maximization algorithm to obtain the optimal initial values for matrix p and vector l (10 times slower then Matlab)
- _generate_adj_ to obtain the final adjacency matrix of the weighted multifractal graph 
- _graphToMatAdjMatrix_ to export the adjacency matrix of graph to a .mat file
